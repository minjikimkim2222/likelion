...
public class Banker {
    ...
    // 통장 개설 승인
    public Account approveOpenAccount(Bank bank, String accountNumber, String accountHolderName, int balance) throws BankCapacityExceededException, AccountAlreadyExistsException {
